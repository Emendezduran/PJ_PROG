...
public class Juego_AhorcadoJOp implements Game {

    public static void main(String[] args) {

        Juego_AhorcadoJOp j = new Juego_AhorcadoJOp();
        j.startGame();
    }
    ...
    JOptionPane.ERROR_MESSAGE);
        } else JOptionPane.showMessageDialog(frame,"FELICIDADES! HAS ADIVINADO LA PALABRA." + "\n" + palabra,"WIN!",JOptionPane.WARNING_MESSAGE);
    }

    public Juego_AhorcadoJOp() {
